...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_games', '-n', type=int, default=100, help='Number of games to run')
    ...
    game, (x_player, o_player) = Game(game=args.game), Player(player1='qlearning', player2='alphabeta')
